...
export function paintPageContents(page, container) {
    ...
    container.appendChild(div);
                ...
                // === FIX #7: ROTATION ===
                div.style.cssText = `left: ${box.left}px; top: ${box.top}px; width: ${box.width}px; height: ${box.height}px; z-index: ${box.zIndex || 10}; transform: rotate(${box.rotation || 0}deg); ${box.hasWhiteBorder ? 'box-sizing: border-box !important; border: 6px solid #ffffff !important;' : ''}`;
